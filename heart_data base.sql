...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Bulan Mei 2023 pada 12.57
...
CREATE TABLE `dataset` (
  ...
  `sex` int(11) NOT NULL,
  `cp` int(11) NOT NULL,
  `trtbps` int(11) NOT NULL,
  `chol` int(11) NOT NULL,
  `fbs` int(11) NOT NULL,
  `restecg` int(11) NOT NULL,
  `thalachh` int(11) NOT NULL,
  `exng` int(11) NOT NULL,
  `oldpeak` double DEFAULT NULL,
  `slp` int(11) NOT NULL,
  `caa` int(11) NOT NULL,
  `thall` int(11) NOT NULL,
...
INSERT INTO `dataset` (`dataset_id`, `age`, `sex`, `cp`, `trtbps`, `chol`, `fbs`, `restecg`, `thalachh`, `exng`, `oldpeak`, `slp`, `caa`, `thall`, `output`) VALUES
...
(15, 58, 0, 3, 150, 283, 1, 0, 162, 0, 1, 2, 0, 2, 1),
(16, 50, 0, 2, 120, 219, 0, 1, 158, 0, 1.6, 1, 0, 2, 1),
(17, 58, 0, 2, 120, 340, 0, 1, 172, 0, 0, 2, 0, 2, 1),
...
(23, 42, 1, 0, 140, 226, 0, 1, 178, 0, 0, 2, 0, 2, 1),
(24, 61, 1, 2, 150, 243, 1, 1, 137, 1, 1, 1, 0, 2, 1),
...
(43, 45, 1, 0, 104, 208, 0, 0, 148, 1, 3, 1, 0, 2, 1),
(44, 53, 0, 0, 130, 264, 0, 0, 143, 0, 0.4, 1, 0, 2, 1),
(45, 39, 1, 2, 140, 321, 0, 0, 182, 0, 0, 2, 0, 2, 1),
(46, 52, 1, 1, 120, 325, 0, 1, 172, 0, 0.2, 2, 0, 2, 1),
(47, 44, 1, 2, 140, 235, 0, 0, 180, 0, 0, 2, 0, 2, 1),
(48, 47, 1, 2, 138, 257, 0, 0, 156, 0, 0, 2, 0, 2, 1),
(49, 53, 0, 2, 128, 216, 0, 0, 115, 0, 0, 2, 0, 0, 1),
(50, 53, 0, 0, 138, 234, 0, 0, 160, 0, 0, 2, 0, 2, 1),
...
(55, 63, 0, 2, 135, 252, 0, 0, 172, 0, 0, 2, 0, 2, 1),
(56, 52, 1, 1, 134, 201, 0, 1, 158, 0, 0.8, 2, 1, 2, 1),
(57, 48, 1, 0, 122, 222, 0, 0, 186, 0, 0, 2, 0, 2, 1),
(58, 45, 1, 0, 115, 260, 0, 0, 185, 0, 0, 2, 0, 2, 1),
(59, 34, 1, 3, 118, 182, 0, 0, 174, 0, 0, 2, 0, 2, 1),
(60, 57, 0, 0, 128, 303, 0, 0, 159, 0, 0, 2, 1, 2, 1),
(61, 71, 0, 2, 110, 265, 1, 0, 130, 0, 0, 2, 1, 2, 1),
(62, 54, 1, 1, 108, 309, 0, 1, 156, 0, 0, 2, 0, 3, 1),
(63, 52, 1, 3, 118, 186, 0, 0, 190, 0, 0, 1, 0, 1, 1),
(64, 41, 1, 1, 135, 203, 0, 1, 132, 0, 0, 1, 0, 1, 1),
(65, 58, 1, 2, 140, 211, 1, 0, 165, 0, 0, 2, 0, 2, 1),
(66, 35, 0, 0, 138, 183, 0, 1, 182, 0, 1.4, 2, 0, 2, 1),
(67, 51, 1, 2, 100, 222, 0, 1, 143, 1, 1.2, 1, 0, 2, 1),
(68, 45, 0, 1, 130, 234, 0, 0, 175, 0, 0.6, 1, 0, 2, 1),
(69, 44, 1, 1, 120, 220, 0, 1, 170, 0, 0, 2, 0, 2, 1),
(70, 62, 0, 0, 124, 209, 0, 1, 163, 0, 0, 2, 0, 2, 1),
(71, 54, 1, 2, 120, 258, 0, 0, 147, 0, 0.4, 1, 0, 3, 1),
(72, 51, 1, 2, 94, 227, 0, 1, 154, 1, 0, 2, 1, 3, 1),
(73, 29, 1, 1, 130, 204, 0, 0, 202, 0, 0, 2, 0, 2, 1),
(74, 51, 1, 0, 140, 261, 0, 0, 186, 1, 0, 2, 0, 2, 1),
(75, 43, 0, 2, 122, 213, 0, 1, 165, 0, 0.2, 1, 0, 2, 1),
(76, 55, 0, 1, 135, 250, 0, 0, 161, 0, 1.4, 1, 0, 2, 1),
(77, 51, 1, 2, 125, 245, 1, 0, 166, 0, 2.4, 1, 0, 2, 1),
(78, 59, 1, 1, 140, 221, 0, 1, 164, 1, 0, 2, 0, 2, 1),
(79, 52, 1, 1, 128, 205, 1, 1, 184, 0, 0, 2, 0, 2, 1),
(80, 58, 1, 2, 105, 240, 0, 0, 154, 1, 0.6, 1, 0, 3, 1),
(81, 41, 1, 2, 112, 250, 0, 1, 179, 0, 0, 2, 0, 2, 1),
(82, 45, 1, 1, 128, 308, 0, 0, 170, 0, 0, 2, 0, 2, 1),
(83, 60, 0, 2, 102, 318, 0, 1, 160, 0, 0, 2, 1, 2, 1),
(84, 52, 1, 3, 152, 298, 1, 1, 178, 0, 1.2, 1, 0, 3, 1),
(85, 42, 0, 0, 102, 265, 0, 0, 122, 0, 0.6, 1, 0, 2, 1),
(86, 67, 0, 2, 115, 564, 0, 0, 160, 0, 1.6, 1, 0, 3, 1),
(87, 68, 1, 2, 118, 277, 0, 1, 151, 0, 1, 2, 1, 3, 1),
(88, 46, 1, 1, 101, 197, 1, 1, 156, 0, 0, 2, 0, 3, 1),
(89, 54, 0, 2, 110, 214, 0, 1, 158, 0, 1.6, 1, 0, 2, 1),
(90, 58, 0, 0, 100, 248, 0, 0, 122, 0, 1, 1, 0, 2, 1),
(91, 48, 1, 2, 124, 255, 1, 1, 175, 0, 0, 2, 2, 2, 1),
(92, 57, 1, 0, 132, 207, 0, 1, 168, 1, 0, 2, 0, 3, 1),
(93, 52, 1, 2, 138, 223, 0, 1, 169, 0, 0, 2, 4, 2, 1),
(94, 54, 0, 1, 132, 288, 1, 0, 159, 1, 0, 2, 1, 2, 1),
(95, 45, 0, 1, 112, 160, 0, 1, 138, 0, 0, 1, 0, 2, 1),
(96, 53, 1, 0, 142, 226, 0, 0, 111, 1, 0, 2, 0, 3, 1),
(97, 62, 0, 0, 140, 394, 0, 0, 157, 0, 1.2, 1, 0, 2, 1),
(98, 52, 1, 0, 108, 233, 1, 1, 147, 0, 0.1, 2, 3, 3, 1),
(99, 43, 1, 2, 130, 315, 0, 1, 162, 0, 1.9, 2, 1, 2, 1),
(100, 53, 1, 2, 130, 246, 1, 0, 173, 0, 0, 2, 3, 2, 1),
(101, 42, 1, 3, 148, 244, 0, 0, 178, 0, 0.8, 2, 2, 2, 1),
(102, 59, 1, 3, 178, 270, 0, 0, 145, 0, 4.2, 0, 0, 3, 1),
(103, 63, 0, 1, 140, 195, 0, 1, 179, 0, 0, 2, 2, 2, 1),
(104, 42, 1, 2, 120, 240, 1, 1, 194, 0, 0.8, 0, 0, 3, 1),
(105, 50, 1, 2, 129, 196, 0, 1, 163, 0, 0, 2, 0, 2, 1),
...
(110, 50, 0, 0, 110, 254, 0, 0, 159, 0, 0, 2, 0, 2, 1),
(111, 64, 0, 0, 180, 325, 0, 1, 154, 1, 0, 2, 0, 2, 1),
(112, 57, 1, 2, 150, 126, 1, 1, 173, 0, 0.2, 2, 1, 3, 1),
(113, 64, 0, 2, 140, 313, 0, 1, 133, 0, 0.2, 2, 0, 3, 1),
(114, 43, 1, 0, 110, 211, 0, 1, 161, 0, 0, 2, 0, 3, 1),
(115, 55, 1, 1, 130, 262, 0, 1, 155, 0, 0, 2, 0, 2, 1),
(116, 37, 0, 2, 120, 215, 0, 1, 170, 0, 0, 2, 0, 2, 1),
(117, 41, 1, 2, 130, 214, 0, 0, 168, 0, 2, 1, 0, 2, 1),
(118, 56, 1, 3, 120, 193, 0, 0, 162, 0, 1.9, 1, 0, 3, 1),
(119, 46, 0, 1, 105, 204, 0, 1, 172, 0, 0, 2, 0, 2, 1),
(120, 46, 0, 0, 138, 243, 0, 0, 152, 1, 0, 1, 0, 2, 1),
(121, 64, 0, 0, 130, 303, 0, 1, 122, 0, 2, 1, 2, 2, 1),
(122, 59, 1, 0, 138, 271, 0, 0, 182, 0, 0, 2, 0, 2, 1),
(123, 41, 0, 2, 112, 268, 0, 0, 172, 1, 0, 2, 0, 2, 1),
(124, 54, 0, 2, 108, 267, 0, 0, 167, 0, 0, 2, 0, 2, 1),
(125, 39, 0, 2, 94, 199, 0, 1, 179, 0, 0, 2, 0, 2, 1),
(126, 34, 0, 1, 118, 210, 0, 1, 192, 0, 0.7, 2, 0, 2, 1),
(127, 47, 1, 0, 112, 204, 0, 1, 143, 0, 0.1, 2, 0, 2, 1),
(128, 67, 0, 2, 152, 277, 0, 1, 172, 0, 0, 2, 1, 2, 1),
(129, 52, 0, 2, 136, 196, 0, 0, 169, 0, 0.1, 1, 0, 2, 1),
(130, 74, 0, 1, 120, 269, 0, 0, 121, 1, 0.2, 2, 1, 2, 1),
(131, 54, 0, 2, 160, 201, 0, 1, 163, 0, 0, 2, 1, 2, 1),
(132, 49, 0, 1, 134, 271, 0, 1, 162, 0, 0, 1, 0, 2, 1),
(133, 42, 1, 1, 120, 295, 0, 1, 162, 0, 0, 2, 0, 2, 1),
(134, 41, 1, 1, 110, 235, 0, 1, 153, 0, 0, 2, 0, 2, 1),
(135, 41, 0, 1, 126, 306, 0, 1, 163, 0, 0, 2, 0, 2, 1),
(136, 49, 0, 0, 130, 269, 0, 1, 163, 0, 0, 2, 0, 2, 1),
(137, 60, 0, 2, 120, 178, 1, 1, 96, 0, 0, 2, 0, 2, 1),
(138, 62, 1, 1, 128, 208, 1, 0, 140, 0, 0, 2, 0, 2, 1),
...
(143, 42, 0, 2, 120, 209, 0, 1, 173, 0, 0, 1, 0, 2, 1),
(144, 67, 0, 0, 106, 223, 0, 1, 142, 0, 0.3, 2, 2, 2, 1),
(145, 76, 0, 2, 140, 197, 0, 2, 116, 0, 1.1, 1, 0, 2, 1),
(146, 70, 1, 1, 156, 245, 0, 0, 143, 0, 0, 2, 0, 2, 1),
(147, 44, 0, 2, 118, 242, 0, 1, 149, 0, 0.3, 1, 1, 2, 1),
(148, 60, 0, 3, 150, 240, 0, 1, 171, 0, 0.9, 2, 0, 2, 1),
(149, 44, 1, 2, 120, 226, 0, 1, 169, 0, 0, 2, 0, 2, 1),
(150, 42, 1, 2, 130, 180, 0, 1, 150, 0, 0, 2, 0, 2, 1),
(151, 66, 1, 0, 160, 228, 0, 0, 138, 0, 2.3, 2, 0, 1, 1),
(152, 71, 0, 0, 112, 149, 0, 1, 125, 0, 1.6, 1, 0, 2, 1),
(153, 64, 1, 3, 170, 227, 0, 0, 155, 0, 0.6, 1, 0, 3, 1),
(154, 66, 0, 2, 146, 278, 0, 0, 152, 0, 0, 1, 1, 2, 1),
(155, 39, 0, 2, 138, 220, 0, 1, 152, 0, 0, 1, 0, 2, 1),
(156, 58, 0, 0, 130, 197, 0, 1, 131, 0, 0.6, 1, 0, 2, 1),
(157, 47, 1, 2, 130, 253, 0, 1, 179, 0, 0, 2, 0, 2, 1),
(158, 35, 1, 1, 122, 192, 0, 1, 174, 0, 0, 2, 0, 2, 1),
(159, 58, 1, 1, 125, 220, 0, 1, 144, 0, 0.4, 1, 4, 3, 1),
(160, 56, 1, 1, 130, 221, 0, 0, 163, 0, 0, 2, 0, 3, 1),
(161, 56, 1, 1, 120, 240, 0, 1, 169, 0, 0, 0, 0, 2, 1),
(162, 55, 0, 1, 132, 342, 0, 1, 166, 0, 1.2, 2, 0, 2, 1),
(163, 41, 1, 1, 120, 157, 0, 1, 182, 0, 0, 2, 0, 2, 1),
...
(195, 60, 1, 2, 140, 185, 0, 0, 155, 0, 3, 1, 0, 2, 0),
...
(201, 44, 1, 0, 110, 197, 0, 0, 177, 0, 0, 2, 1, 2, 0),
...
(231, 47, 1, 2, 108, 243, 0, 1, 152, 0, 0, 2, 0, 2, 0),
(232, 57, 1, 0, 165, 289, 1, 0, 124, 0, 1, 1, 3, 3, 0),
...
(237, 58, 1, 0, 125, 300, 0, 0, 171, 0, 0, 2, 2, 3, 0),
(238, 60, 1, 0, 140, 293, 0, 0, 170, 0, 1.2, 1, 2, 3, 0),
(239, 77, 1, 0, 125, 304, 0, 0, 162, 1, 0, 2, 3, 2, 0),
(240, 35, 1, 0, 126, 282, 0, 0, 156, 1, 0, 2, 0, 3, 0),
(241, 70, 1, 2, 160, 269, 0, 1, 112, 1, 2.9, 1, 1, 3, 0),
(242, 59, 0, 0, 174, 249, 0, 1, 143, 1, 0, 1, 0, 2, 0),
(243, 64, 1, 0, 145, 212, 0, 0, 132, 0, 2, 1, 2, 1, 0),
...
(248, 66, 1, 1, 160, 246, 0, 1, 120, 1, 0, 1, 3, 1, 0),
(249, 54, 1, 1, 192, 283, 0, 0, 195, 0, 0, 2, 1, 3, 0),
(250, 69, 1, 2, 140, 254, 0, 0, 146, 0, 2, 1, 3, 3, 0),
...
(255, 59, 1, 3, 160, 273, 0, 0, 125, 0, 0, 2, 0, 2, 0),
(256, 45, 1, 0, 142, 309, 0, 0, 147, 1, 0, 1, 3, 3, 0),
(257, 58, 1, 0, 128, 259, 0, 0, 130, 1, 3, 1, 2, 3, 0),
(258, 50, 1, 0, 144, 200, 0, 0, 126, 1, 0.9, 1, 0, 3, 0),
(259, 62, 0, 0, 150, 244, 0, 1, 154, 1, 1.4, 1, 0, 2, 0),
(260, 38, 1, 3, 120, 231, 0, 1, 182, 1, 3.8, 1, 0, 3, 0),
(261, 66, 0, 0, 178, 228, 1, 1, 165, 1, 1, 1, 2, 3, 0),
(262, 52, 1, 0, 112, 230, 0, 1, 160, 0, 0, 2, 1, 2, 0),
(263, 53, 1, 0, 123, 282, 0, 1, 95, 1, 2, 1, 2, 3, 0),
(264, 63, 0, 0, 108, 269, 0, 1, 169, 1, 1.8, 1, 2, 2, 0),
(265, 54, 1, 0, 110, 206, 0, 0, 108, 1, 0, 1, 1, 2, 0),
...
(273, 67, 1, 0, 120, 237, 0, 1, 71, 0, 1, 1, 0, 2, 0),
(274, 58, 1, 0, 100, 234, 0, 1, 156, 0, 0.1, 2, 1, 3, 0),
(275, 47, 1, 0, 110, 275, 0, 0, 118, 1, 1, 1, 1, 2, 0),
(276, 52, 1, 0, 125, 212, 0, 1, 168, 0, 1, 2, 2, 3, 0),
(277, 58, 1, 0, 146, 218, 0, 1, 105, 0, 2, 1, 1, 3, 0),
(278, 57, 1, 1, 124, 261, 0, 1, 141, 0, 0.3, 2, 0, 3, 0),
(279, 58, 0, 1, 136, 319, 1, 0, 152, 0, 0, 2, 2, 2, 0),
(280, 61, 1, 0, 138, 166, 0, 0, 125, 1, 3.6, 1, 1, 2, 0),
(281, 42, 1, 0, 136, 315, 0, 1, 125, 1, 1.8, 1, 0, 1, 0),
(282, 52, 1, 0, 128, 204, 1, 1, 156, 1, 1, 1, 0, 0, 0),
(283, 59, 1, 2, 126, 218, 1, 1, 134, 0, 2.2, 1, 1, 1, 0),
(284, 40, 1, 0, 152, 223, 0, 1, 181, 0, 0, 2, 0, 3, 0),
(285, 61, 1, 0, 140, 207, 0, 0, 138, 1, 1.9, 2, 1, 3, 0),
(286, 46, 1, 0, 140, 311, 0, 1, 120, 1, 1.8, 1, 2, 3, 0),
(287, 59, 1, 3, 134, 204, 0, 1, 162, 0, 0.8, 2, 2, 2, 0),
(288, 57, 1, 1, 154, 232, 0, 0, 164, 0, 0, 2, 1, 2, 0),
(289, 57, 1, 0, 110, 335, 0, 1, 143, 1, 3, 1, 1, 3, 0),
(290, 55, 0, 0, 128, 205, 0, 2, 130, 1, 2, 1, 1, 3, 0),
(291, 61, 1, 0, 148, 203, 0, 1, 161, 0, 0, 2, 1, 3, 0),
...
(296, 63, 1, 0, 140, 187, 0, 0, 144, 1, 4, 2, 2, 3, 0),
(297, 63, 0, 0, 124, 197, 0, 1, 136, 1, 0, 1, 0, 2, 0),
...
CREATE TABLE `predict` (
  ...
  `k-means` int(11) NOT NULL,
  `Bayes` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data untuk tabel `predict`
--

INSERT INTO `predict` (`predict_id`, `k-means`, `Bayes`) VALUES
(1, 0, 1),
(2, 0, 1),
(3, 0, 1),
(4, 0, 1),
...
ALTER TABLE `dataset`
  ...
  ADD KEY `sex_index` (`sex`),
  ADD KEY `cp_index` (`cp`),
  ADD KEY `trtbps_index` (`trtbps`),
  ADD KEY `chol_index` (`chol`),
  ADD KEY `fbs_index` (`fbs`),
  ADD KEY `restecg_index` (`restecg`),
  ADD KEY `thalachh_index` (`thalachh`),
  ADD KEY `exng_index` (`exng`),
  ADD KEY `slp_index` (`slp`),
  ADD KEY `caa_index` (`caa`),
  ADD KEY `thall_index` (`thall`),
  ADD KEY `output_index` (`output`);
...
--
ALTER TABLE `dataset`
  MODIFY `dataset_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=304;

--
-- AUTO_INCREMENT untuk tabel `predict`
--
ALTER TABLE `predict`
  MODIFY `predict_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
COMMIT;
